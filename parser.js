...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'h1', 'h2', 'a', 'p', 'div', 'h3']]
};

const htmlTableAttributesTestCase = {
    testCaseName: 'HTML Table Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['a', ['href']]
};

const htmlDivAttributesTestCase = {
    testCaseName: 'HTML Div Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['div', ['id']]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlDivAttributesTestCase.testCaseName, htmlDivAttributesTestCase.testCaseType, htmlDivAttributesTestCase.testLogic, htmlDivAttributesTestCase.extraParams);
}
